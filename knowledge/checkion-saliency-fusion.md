...
|----------|------------|--------|
| `SALIENCY_FUSION_STRUCTURE_WEIGHT` | Gewicht der DOM/Struktur-Map bei der Fusion (0 = aus). | `0.25` |
...
- **Fusion:** [lib/saliency-fusion.ts](../lib/saliency-fusion.ts) – `buildStructureAttentionMap`, `buildVisionPriorMap`, `decodeJetPngToIntensity`, `intensityToJetPng`, `fuseSaliencyHeatmap`.
