            ...
            >
                ...
                >
                    ...
                    <Endpoint
                        ...
                        desc={t('developers.contrastDesc')}
                        params="?f=000000&b=ffffff"
                    />
                    <Endpoint
                        method="POST"
                        path="/api/tools/readability"
                        desc={t('developers.readabilityDesc')}
                        body='{ "text": "..." }'
                    />
                    <Endpoint
                        method="GET"
                        path="/api/tools/extract"
                        desc={t('developers.extractDesc')}
                        params="?url=...&selector=h1"
                    />
                    <Endpoint
                        method="GET"
                        path="/api/tools/ssl-labs"
                        desc={t('developers.sslLabsDesc')}
                        params="?host=example.com"
                    />
                    <Endpoint
                        method="GET"
                        path="/api/tools/pagespeed"
                        desc={t('developers.pagespeedDesc')}
                        params="?url=https://example.com"
                    />
                    <Endpoint
                        method="GET"
                        path="/api/tools/wayback"
                        desc={t('developers.waybackDesc')}
                        params="?url=https://example.com"
                    />
                </MsqdxCard>
                ...
                >
                    ...
                    <Endpoint
                        method="GET"
                        path="/api/scan"
                        desc={t('developers.scanListDesc')}
                        params="?page=1&limit=20&projectId=&industry=&tag="
                    />
                    <Endpoint method="GET" path="/api/scans" desc={t('developers.scansLegacyDesc')} />
                    <Endpoint
                        method="POST"
                        path="/api/scan"
                        desc={t('developers.scanPostDesc')}
                        body='{ "url": "..." }'
                    />
                    <Endpoint
                        method="GET"
                        path="/api/scans/domain"
                        desc={t('developers.scansDomainDesc')}
                        params="?page=1&limit=20&q=&status=complete&projectId="
                    />
                    <Endpoint
                        method="POST"
                        path="/api/scans/domain/compare"
                        desc={t('developers.scansDomainCompareDesc')}
                        body='{ "ids": ["uuid-a", "uuid-b"] }'
                    />
                    <Endpoint
                        method="POST"
                        path="/api/scan/domain"
                        desc={t('developers.scanDomainPostDesc')}
                        body='{ "url": "https://...", "useSitemap": true }'
                    />
        ...
        >
            ...
            >
                <MsqdxChip
                    ...
                    size="small"
                    variant="outlined"
                    brandColor={chipColor}
                    sx={{ fontWeight: 700, fontSize: '0.7rem' }}
                />
                <MsqdxTypography variant="subtitle2" sx={{ fontFamily: 'monospace' }}>
                    {path}
                </MsqdxTypography>
            </Box>
