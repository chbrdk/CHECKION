/* GET /api/projects/[id]/domain-summary-all – uses shared lib/project-summaries/domain-summary-all.ts */
...
export async function GET(
  ...
  const { own, competitors } = await buildProjectDomainSummaryAll(project.userId, projectId);
