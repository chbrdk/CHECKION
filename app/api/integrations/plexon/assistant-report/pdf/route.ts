...
import { renderPlexonAssistantReportPdf } from '@/lib/integrations/plexon/render-assistant-report-pdf';
...
export async function POST(request: Request) {
  ...
  try {
    const pdf = await renderPlexonAssistantReportPdf({
    ...
    return new NextResponse(new Uint8Array(pdf), {
      ...
      headers: {
        ...
        'Content-Disposition': `attachment; filename="plexon-assistant-report-${slug}.pdf"`,
