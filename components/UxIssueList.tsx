...
import { MousePointerClick, Smartphone, AlertTriangle, Unlink } from 'lucide-react';
...
export const UxIssueList = ({ ux }: UxIssueListProps) => {
    ...
    return (
        <MsqdxAccordion allowMultiple size="small" borderRadius="md">
                ...
                <MsqdxAccordionItem
                    ...
                    summary={
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, width: '100%' }}>
                            ...
                            <Box sx={{ flex: 1 }}>
                                <MsqdxTypography variant="subtitle2" fontWeight={600}>
            ...
            {ux.brokenLinks && ux.brokenLinks.map((link, idx) => (
                ...
                >
                    <Box sx={{ p: 1 }}>
                        ...
                        <MsqdxTypography variant="caption" color="primary" component="a" href={link.href} target="_blank" rel="noopener noreferrer">
                            Visit URL ↗
                        </MsqdxTypography>
                    </Box>
                </MsqdxAccordionItem>
            ...
            {/* Tap Target Issues */}
            {ux.tapTargets.issues.map((issue, idx) => (
                <MsqdxAccordionItem
                    key={`tap-${idx}`}
                    id={`tap-${idx}`}
                    summary={
