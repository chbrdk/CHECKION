            ...
            {showList && (
                <Box component="ul" sx={{ listStyle: 'none', m: 0, p: 0 }}>
                            ...
                            <Box sx={{ flex: 1, minWidth: 0 }}>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap', mb: 0.5 }}>
                                    <MsqdxChip
                                        label={
                                            match.type === 'single'
                                                ? t('dashboard.searchType_single')
                                                : t('dashboard.searchType_domain')
                                        }
                                        size="small"
                                        variant="outlined"
                                        sx={{
                                            ...
                                            bgcolor:
                                                match.type === 'single'
                                                    ...
                                                    : 'var(--color-secondary-dx-purple-tint)',
                                            color:
                                                match.type === 'single'
                    ...
                    <LoadMoreBar
                        ...
                        onLoadMore={() =>
                            setDisplayCount((c) => Math.min(c + SEARCH_RESULTS_PAGE_SIZE, matches.length))
                        }
