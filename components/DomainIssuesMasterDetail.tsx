...
function IssuesEmptyState({
    ...
    return (
        ...
        >
            ...
            <MsqdxTypography
                variant="body2"
                sx={{ fontWeight: 600, color: 'var(--color-text-secondary-on-light, #404040)' }}
            >
                {title}
            </MsqdxTypography>
            {subtitle && (
...
function DomainIssuesMasterDetailInner({
    ...
    useEffect(() => {
        ...
        setGroupsError(null);
        fetch(
            apiScanDomainIssueGroups(domainId, {
        ...
        >
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 1 }}>
                        ...
                        >
                            ...
                            <ToggleButton
                                ...
                                sx={{
                                    '&.Mui-selected': {
                                        bgcolor: alpha(MSQDX_STATUS.error.base, 0.15),
            ...
            >
                {navigStep === 1 && (
                    ...
                    >
                        {groupsError && (
                            <MsqdxTypography variant="body2" sx={{ color: MSQDX_STATUS.error.base, flexShrink: 0 }}>
                                {groupsError}
                            </MsqdxTypography>
                        )}
                                                        ...
                                                        <Box sx={{ flex: 1, minWidth: 0, py: 0.5, pr: 1, pl: 0.75 }}>
                                                            ...
                                                            >
                                                                ...
                                                                <MsqdxChip
                                                                    size="small"
                                                                    variant="outlined"
                                                                    label={`${g.pageCount} ${t('domainResult.issuesTablePages')}`}
                    ...
                    >
                        <Box sx={{ flexShrink: 0, mb: 1 }}>
                            <MsqdxButton
                                variant="text"
                                size="small"
                                startIcon={<ChevronLeft size={18} strokeWidth={2} aria-hidden />}
                                onClick={onBackToGroups}
                                sx={{ color: MSQDX_BRAND_PRIMARY.green, textTransform: 'none', px: 0.5 }}
                            >
                                                ...
                                                >
                                                    <Box
                                                        sx={{
                                                            ...
                                                            borderRadius: 1,
                                                            bgcolor: active
                                                                ? alpha(MSQDX_BRAND_PRIMARY.green, 0.06)
                                                                : 'var(--color-card-bg)',
                                                        }}
                                                    >
                                                            ...
                                                            >
                                                                ...
                                                                <Tooltip title={t('domainResult.openPage')}>
                                                                    <IconButton
                                                                        size="small"
                                                                        sx={{ p: 0.35 }}
                                                                        aria-label={t('domainResult.openPageAria', {
                                                                            url: p.url,
                                                                        })}
                                                                        onClick={(e) => {
                                                                            e.preventDefault();
                                    ...
                                    {groupPagesCursor && (
                                        <Box sx={{ py: 1, display: 'flex', justifyContent: 'center' }}>
                                            <MsqdxButton
                                                variant="outlined"
                                                size="small"
                                                onClick={loadMoreGroupPages}
                                                disabled={groupPagesLoading}
                                            >
                    ...
                    >
                        ...
                        {pageIssuesLoading ? (
                            ...
                            >
                                <IssuesEmptyState
                                    icon={FileSearch}
                                    title={t('domainResult.issuesEmptyNoIssuesTitle')}
                                />
                            </Box>
                        ) : (
                            <Box sx={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
                                    ...
                                    {pageIssuesCursor && (
                                        <Box sx={{ py: 1, display: 'flex', justifyContent: 'center' }}>
                                            <MsqdxButton
                                                variant="outlined"
                                                size="small"
                                                onClick={loadMorePageIssues}
                                                disabled={pageIssuesLoading}
                                            >
