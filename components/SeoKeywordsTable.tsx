...
export function SeoKeywordsTable({ keywords }: { keywords: CrossPageKeyword[] }) {
    ...
    const pageRows = useMemo(() => sorted.slice(start, start + SEO_TABLE_PAGE_SIZE), [sorted, start]);
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', minWidth: 0, isolation: 'isolate' }}>
            ...
            >
                <Box
                    component="div"
                    role="table"
                    aria-label={t('projects.seo.keywordsTableTitle')}
                ...
                >
                    ...
                    >
                        <SortHeader
                            id="keyword"
                            label={t('projects.seo.keywordsColKeyword')}
                        ...
                        <SortHeader
                            id="totalCount"
                            label={t('projects.seo.keywordsColCount')}
                        ...
                        <SortHeader
                            id="pageCount"
                            label={t('projects.seo.keywordsColPages')}
                            active={sortKey === 'pageCount'}
                            sortDir={sortDir}
                            onSort={handleSort}
                        />
                        <SortHeader
                            id="avgDensityPercent"
                            label={t('projects.seo.keywordsColAvgDensity')}
                            active={sortKey === 'avgDensityPercent'}
                            sortDir={sortDir}
                            onSort={handleSort}
                        />
                    </Box>
                    {pageRows.map((row) => (
                        ...
                        >
                            ...
                            <Box sx={{ px: 1, py: 0.5, fontSize: '0.75rem' }}>
                                {row.totalCount.toLocaleString('de-DE')}
                            </Box>
