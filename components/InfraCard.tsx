            ...
            <Box sx={{ display: 'grid', gap: 'var(--msqdx-spacing-sm)' }}>
                        ...
                        >
                            {(geo.detectedPlatforms ?? []).map((p) => (
                                <MsqdxChip
                                    ...
                                    variant="outlined"
                                    sx={{
                                        bgcolor: alpha(MSQDX_BRAND_PRIMARY.purple, 0.12),
                                        color: MSQDX_BRAND_PRIMARY.purple,
                                        height: 22,
                                        fontSize: '0.7rem',
                                    }}
                            ...
                            {(geo.detectedTracking ?? []).map((t, i) => (
                                <MsqdxChip
                                    ...
                                    sx={{
                                        height: 22,
                                        fontSize: '0.65rem',
                                        borderColor: alpha(MSQDX_STATUS.warning.base, 0.4),
                                    }}
                                />
                            ))}
                        </Box>
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--msqdx-spacing-sm)' }}>
                    <Box>
                        ...
                        <MsqdxTypography
                            variant="body2"
                            sx={{ fontFamily: 'monospace', color: MSQDX_BRAND_PRIMARY.purple, fontSize: '0.85rem' }}
                        >
                ...
                <Box>
                    ...
                    <Box sx={{ display: 'flex', gap: 'var(--msqdx-spacing-xs)', flexWrap: 'wrap' }}>
                        {geo.languages.htmlLang && (
                            <MsqdxChip
                                label={`HTML: ${geo.languages.htmlLang}`}
                                size="small"
                                variant="outlined"
                ...
                {(performance?.nextHopProtocol ||
                    performance?.scriptTransferBytesApprox ||
                    technicalInsights?.mainDocumentCache) && (
                    <Box
                        sx={{
                            mt: 1,
                            p: 1.5,
                    ...
                    >
                        ...
                        {performance?.scriptTransferBytesApprox != null &&
                        ...
                        {technicalInsights?.staticAssetCacheWeak && (
                            <MsqdxTypography
                                variant="caption"
                                sx={{ color: MSQDX_STATUS.warning.base, display: 'block', mt: 0.5 }}
                            >
