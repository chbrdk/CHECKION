            ...
            <Box sx={{ display: 'grid', gap: 'var(--msqdx-spacing-sm)' }}>
                ...
                >
                    ...
                    {insights.appleTouchIcon ? (
                        <MsqdxTypography
                            variant="caption"
                            sx={{ color: MSQDX_STATUS.success.base, wordBreak: 'break-all' }}
                        >
                            Vorhanden
                        </MsqdxTypography>
                    ) : (
                ...
                {insights.serviceWorkerRegistered !== undefined && (
                    ...
                    >
                        ...
                        <MsqdxTypography
                            variant="caption"
                            sx={{
                                color: insights.serviceWorkerRegistered
                ...
                {insights.metaRefreshPresent !== undefined && (
                    ...
                    >
                        ...
                        <MsqdxTypography
                            variant="caption"
                            sx={{
                                color: insights.metaRefreshPresent
